# --- Loss: engine (density-dependent loss channels) + LossTerm face ---
#
# Engine `apply_loss_step!` is the production propagator half-step
# (called by the integrator/propagators, make_workspace primer, rotating
# basis, …); `LossTerm` is the registry face (RT-only, anti-Hermitian,
# nil energy/gradient). One file = engine + face cohesion.

# ============================================================================
# Engine — density-dependent loss propagator
# ============================================================================
...
# ============================================================================
# LossTerm — registry face. Three-body loss (K3) is non-Hermitian,
# applied in RT only. Energy/gradient contributions are undefined (the
# loss is not a Hamiltonian piece in the standard sense).
# ============================================================================
