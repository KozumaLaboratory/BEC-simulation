...
"""
init_psi_polar(grid, sys; kwargs...) =
    init_psi(grid, sys; state = :polar, init_state_params = Dict{Symbol,Any}(kwargs...))
...
"""
init_psi_ferromagnetic(grid, sys; kwargs...) =
    init_psi(grid, sys; state = :ferromagnetic, init_state_params = Dict{Symbol,Any}(kwargs...))
...
"""
init_psi_ferromagnetic_min(grid, sys; kwargs...) =
    init_psi(grid, sys; state = :ferromagnetic_min, init_state_params = Dict{Symbol,Any}(kwargs...))
...
"""
init_psi_uniform(grid, sys; kwargs...) =
    init_psi(grid, sys; state = :uniform, init_state_params = Dict{Symbol,Any}(kwargs...))
...
"""
init_psi_antiferromagnetic(grid, sys; kwargs...) =
    init_psi(grid, sys; state = :antiferromagnetic, init_state_params = Dict{Symbol,Any}(kwargs...))
...
"""
init_psi_spin_coherent(grid, sys; theta = 0.0, phi = 0.0, kwargs...) =
    init_psi(grid, sys; state = :spin_coherent,
...
"""
init_psi_fl_vortex(grid, sys; winding::Int = 1, theta = π/2, kwargs...) =
    init_psi(grid, sys; state = :fl_vortex,
...
"""
init_psi_spin_helix(grid, sys; q_vector = (0.0, 0.0, 0.0), kwargs...) =
...
"""
init_psi_cyclic(grid, sys; kwargs...) =
    init_psi(grid, sys; state = :cyclic, init_state_params = Dict{Symbol,Any}(kwargs...))
...
init_psi_biaxial_nematic(grid, sys; angles = (0.0, 0.0), kwargs...) = begin
    ...
    p[:theta] = angles[1]; p[:phi] = angles[2]
...
"""
init_psi_polar_core_vortex(grid, sys; winding::Int = 1, axis::Symbol = :z, kwargs...) =
    init_psi(grid, sys; state = :polar_core_vortex,
...
"""
init_psi_bright_soliton(grid, sys; m_state = :max, width = 1.0, kwargs...) =
    init_psi(grid, sys; state = :soliton_bright,
...
"""
init_psi_dark_soliton(grid, sys; m_state = :max, position = 0.0, kwargs...) =
    init_psi(grid, sys; state = :soliton_dark,
...
"""
init_psi_skyrmion(grid, sys; kwargs...) =
    init_psi(grid, sys; state = :skyrmion, init_state_params = Dict{Symbol,Any}(kwargs...))
...
"""
init_psi_domain_wall(grid, sys; axis::Int = 1, kwargs...) =
...
"""
init_psi_two_packets(grid, sys; separation = 2.0, momentum_kick = 1.0, kwargs...) =
    init_psi(grid, sys; state = :two_packet,
        init_state_params = Dict{Symbol,Any}(
...
"""
init_psi_chiral_spin_vortex(grid, sys; winding::Int = 1, kwargs...) =
    init_psi(grid, sys; state = :chiral_spin_vortex,
...
"""
init_psi_magnetic_domain(grid, sys; pattern::Symbol = :stripe, kwargs...) =
    init_psi(grid, sys; state = :magnetic_domain,
...
init_psi_vortex_lattice(grid, sys; n_vortices::Int = 4,
                        lattice::Symbol = :triangular, kwargs...) =
...
"""
init_psi_skyrmion_lattice(grid, sys; q_vector = (2π, 0.0, 0.0), kwargs...) =
