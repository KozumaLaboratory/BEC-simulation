...
`docs/design/integrator_phase_minus_1_protocol.md`.

The thesis section is **§3.6 Modified splitting for spinor + DDI**. See
`docs/design/integrator_ch3_plan.md` and `docs/design/integrator_ch3_6_narrative.md`
...
in `docs/design/integrator_track_c_derivation.md` Step 5. The Lie-derivative
...
For §3.6 narrative see `docs/design/integrator_ch3_6_narrative.md`.
