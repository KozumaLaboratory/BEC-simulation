...
**Track B closure**. See `docs/design/integrator_ch3_plan.md` for overall Ch.3.
...
(Algebra in `docs/design/integrator_track_b_derivation.md` Step 1.1.)
...
- ✓ J=1 reduction verified: Thalhammer eq 22 ≡ Chin-Krotscheck 4A
  (Step 1.1-1.3 in `docs/design/integrator_track_b_derivation.md`)
