...
§3.3.1 in `docs/design/integrator_ch3_plan.md` for the formal common-framework
analysis.
...
captured in §3.3 of `docs/design/integrator_ch3_plan.md`.
...
Behind hard gate. See `docs/design/integrator_track_c_derivation.md`. Time cap
...
2. **Track C Phase -1** (month 3 entry per `docs/design/integrator_ch3_plan.md`
