...
- `scripts/manuscript/f12_icosahedral_verification.jl`: F=12 (paper3 §IX.B follow-up)
- `scripts/manuscript/sign_pattern_6j_numerical.jl`: Sign Pattern Anomalous Identity
