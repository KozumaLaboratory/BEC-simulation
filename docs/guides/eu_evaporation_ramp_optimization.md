...
Run from the LRW-model worktree
`.claude/worktrees/compressed-swimming-candle` (T₀ = 18 µK, K₃ = 1×10⁻⁴¹). **`main`
still carries the older fitted model** (T₀ = 50 µK, K₃ = 1.6×10⁻⁴⁰) — running this
on `main` gives different absolute numbers:
