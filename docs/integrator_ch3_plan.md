...
This document lives next to `docs/integrator_modernization_plan.md`
(roadmap-level) and the per-track `docs/integrator_track_{c,b}_derivation.md`
(Phase -1 manuscripts). The protocol for entering Phase 0 implementation is
fixed in `docs/integrator_phase_minus_1_protocol.md`.
...
- **§3.5 Force-gradient extension to spinor + DDI** (Track C, Chin 1997 +
  ...
  `docs/integrator_track_c_derivation.md`. Phase 0+ implementation,
...
- **§3.6 Modified splitting for spinor + DDI** (Track B, Thalhammer
  ...
  `docs/integrator_track_b_derivation.md`. Phase 0+ implementation.
...
| C — Force-Gradient + DDI | Phase -1 not started | template at `docs/integrator_track_c_derivation.md` |
| B — Thalhammer modified + DDI | Phase -1 not started | template at `docs/integrator_track_b_derivation.md` |
...
(both documented in `docs/integrator_modernization_plan.md` and
`memory/integrator_modernization_status.md`). The Phase -1 protocol
(`docs/integrator_phase_minus_1_protocol.md`) hardens against this for
