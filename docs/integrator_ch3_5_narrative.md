...
**Track C closure**. See `docs/integrator_ch3_plan.md` for overall Ch.3.
...
Phase -1 manuscript in `docs/integrator_track_c_derivation.md` carries
...
Per §5.2 of `docs/integrator_track_c_derivation.md`, the explicit F=1
symbolic form is:
...
Per §5.3 of `docs/integrator_track_c_derivation.md`, the matrix +
...
per `docs/integrator_ch3_plan.md` schedule.
