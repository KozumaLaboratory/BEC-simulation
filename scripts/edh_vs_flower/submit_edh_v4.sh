...
#$ -l h_rt=4:00:00
#$ -j y
#$ -o /gs/fs/tga-kozuma-kouhi/ue06186/runs/edh_vs_flower_v3/edh_v4.log
set -euo pipefail
...
echo "=== EdH v4 dynamics + diagnostic (c1=1/36) ==="
"$JULIA" --project=. scripts/edh_vs_flower/run_edh_v4.jl runs/eu151_edh_vs_flower/edh_quench_v4.yaml
RDIR=$(ls -d "$DATA"/edh_quench_v4_*/ 2>/dev/null | head -1)
echo "=== extract slices (full 64^3 per-m) + spin3d (32^3) from $RDIR ==="
