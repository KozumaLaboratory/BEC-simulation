...
#$ -l h_rt=6:00:00
#$ -j y
#$ -o /gs/fs/tga-kozuma-kouhi/ue06186/runs/edh_vs_flower_noloss/uge.log

set -euo pipefail

PROJECT_ROOT=${SPINORBEC_TSUBAME_PROJECT_ROOT:-/gs/fs/tga-kozuma-kouhi/ue06186/BEC-simulation}
OUT_DIR=${SPINORBEC_TSUBAME_RUNS_ROOT:-/gs/fs/tga-kozuma-kouhi/ue06186/runs}/edh_vs_flower_noloss
...
"$JULIA" --project=. scripts/edh_vs_flower/run_all.jl \
    runs/eu151_edh_vs_flower/edh_quench_noloss.yaml \
    runs/eu151_edh_vs_flower/flower_smooth_noloss.yaml \
