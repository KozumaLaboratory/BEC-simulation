...
const P_PER_NT = (1.163 * SpinorBEC.Units.BOHR_MAGNETON / SpinorBEC.Units.HBAR) * 1e-9 / OMEGA_REF
...
function main()
    ...
    omega_L_rad_per_s = 1.163 * SpinorBEC.Units.BOHR_MAGNETON / SpinorBEC.Units.HBAR * 2.6e-9
