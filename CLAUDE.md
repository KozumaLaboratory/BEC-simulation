...
julia --project=. examples/bench/bench_eu151.jl
```
...
- `examples/run.jl` — unified YAML runner: pass a file or directory (default: `examples/eu151/`)
...
- YAML configs in `examples/eu151/` and `examples/demo/` follow the schema in `experiment.jl`
