...
# Requirements from `a2_variational_target.jl` (repo Eu151, F=6, N=15000,
...
println("\n-- the trap is a cage, not physics --")
ωt = Float64.(step["potential"]["omega"])
...
include(joinpath(@__DIR__, "b_cells.jl"))
