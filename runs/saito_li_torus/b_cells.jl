...
#     -e 'include("runs/saito_li_torus/b_cells.jl"); main(["T"])'
#   julia --project=. -e 'import CUDA' \
#     -e 'include("runs/saito_li_torus/b_cells.jl"); main(["T","C","smoke=true"])'
#
...
`a1_units_audit.jl` for why scaling both squares the ratio.
"""
