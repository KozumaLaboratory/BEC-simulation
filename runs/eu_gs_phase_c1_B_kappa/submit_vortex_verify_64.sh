...
#  recon winner via seed_from (config_vortex_verify_64.yaml). continuation is OFF
...
CONFIG=$PROJECT_ROOT/runs/eu_gs_phase_c1_B_kappa/config_vortex_verify_64.yaml
